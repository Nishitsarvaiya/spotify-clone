        ...
        <main className={styles.CenterView}>
            <div className={styles.PlaylistHeader}>
                ...
                <div className='relative flex flex-col justify-end'>
                    ...
                    <p className={`text-sm text-white text-opacity-70 tracking-wider mb-1 ${styles.PlaylistDesc}`}>
            ...
            <div className='bg-[#121212] isolate'>
                    ...
                    <div className='flex items-center'>
                        <button className='bg-[#1db954] mr-8 rounded-full flex items-center justify-center min-w-[56px] h-14 w-14 hover:scale-105'>
                            <svg height='28' role='img' width='28' viewBox='0 0 24 24' aria-hidden='true'>
                                <polygon points='21.57 12 5.98 3 5.98 21 21.57 12' fill='#ffffff'></polygon>
                            </svg>
                        </button>
